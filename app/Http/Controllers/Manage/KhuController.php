...
use App\Http\Requests\Manage\CreateKhuRequest;
use App\Http\Requests\Manage\UpdateKhuRequest;
use App\Repositories\Manage\KhuRepository;
...
class KhuController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.khus.index')
            ->with('khus', $khus);
    }
    ...
    {
        return view('backend.khus.create');
    }
    ...
    public function store(CreateKhuRequest $request)
    {
        ...
        return redirect(route('admin.khus.index'));
    }
    ...
    public function show($id)
    {
        ...
        return view('backend.khus.show')->with('khu', $khu);
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.khus.edit')->with('khu', $khu);
    }
